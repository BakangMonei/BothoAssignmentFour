...
public class AddDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cardiologist ", "Pediatrician ", "Ophthalmologist ", "Ear, Nose and Throat Specialist.", "Dentist", "General" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String sql="insert into doctors(IDNumber,Password,FullName,DOB,Gender,PhoneNumber,Specialization)values(?,?,?,?,?,?,?)";
        try{
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "DOCTOR ADDEDD!");
